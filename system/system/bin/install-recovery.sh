#!/system/bin/sh
if ! applypatch --check EMMC:/dev/block/by-name/recovery$(getprop ro.boot.slot_suffix):47185920:eeb3f3f76c0d1a47c436f33295075eb715838889; then
  applypatch \
          --patch /system/recovery-from-boot.p \
          --source EMMC:/dev/block/by-name/boot$(getprop ro.boot.slot_suffix):33554432:10cb5d92f1d57ad52ad8bc64f491b98030cec915 \
          --target EMMC:/dev/block/by-name/recovery$(getprop ro.boot.slot_suffix):47185920:eeb3f3f76c0d1a47c436f33295075eb715838889 && \
